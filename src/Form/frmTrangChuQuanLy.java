...
import ViewPanel.BaoCaoDoanhThu;
import ViewPanel.QuanLyNhanVien;
import ViewPanel.QuanLyLoaiSP;
...
public class frmTrangChuQuanLy extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tab1_QLLSP = new javax.swing.JPanel();
        ...
        tab5_QLNV = new javax.swing.JPanel();
        ...
        tab9_BaoCaoDoanhThu = new javax.swing.JPanel();
        ...
        tab1_QLLSP.setBackground(new java.awt.Color(204, 204, 255));
        tab1_QLLSP.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tab1_QLLSPMouseClicked(evt);
            }
        });
        ...
        javax.swing.GroupLayout tab1_QLLSPLayout = new javax.swing.GroupLayout(tab1_QLLSP);
        tab1_QLLSP.setLayout(tab1_QLLSPLayout);
        tab1_QLLSPLayout.setHorizontalGroup(
            tab1_QLLSPLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(tab1_QLLSPLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jLabel1)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        tab1_QLLSPLayout.setVerticalGroup(
            tab1_QLLSPLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(tab1_QLLSPLayout.createSequentialGroup()
                .addGap(15, 15, 15)
                .addComponent(jLabel1)
        ...
        tab5_QLNV.setBackground(new java.awt.Color(204, 204, 255));
        tab5_QLNV.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tab5_QLNVMouseClicked(evt);
            }
        });
        ...
        javax.swing.GroupLayout tab5_QLNVLayout = new javax.swing.GroupLayout(tab5_QLNV);
        tab5_QLNV.setLayout(tab5_QLNVLayout);
        tab5_QLNVLayout.setHorizontalGroup(
            tab5_QLNVLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(tab5_QLNVLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jLabel5)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        tab5_QLNVLayout.setVerticalGroup(
            tab5_QLNVLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(tab5_QLNVLayout.createSequentialGroup()
                .addGap(16, 16, 16)
                .addComponent(jLabel5)
        ...
        tab9_BaoCaoDoanhThu.setBackground(new java.awt.Color(204, 204, 255));
        tab9_BaoCaoDoanhThu.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tab9_BaoCaoDoanhThuMouseClicked(evt);
            }
        });

        jLabel13.setFont(new java.awt.Font("Arial", 1, 15)); // NOI18N
        jLabel13.setText("Báo Cáo Doanh Thu");

        javax.swing.GroupLayout tab9_BaoCaoDoanhThuLayout = new javax.swing.GroupLayout(tab9_BaoCaoDoanhThu);
        tab9_BaoCaoDoanhThu.setLayout(tab9_BaoCaoDoanhThuLayout);
        tab9_BaoCaoDoanhThuLayout.setHorizontalGroup(
            tab9_BaoCaoDoanhThuLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(tab9_BaoCaoDoanhThuLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jLabel13)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        tab9_BaoCaoDoanhThuLayout.setVerticalGroup(
            tab9_BaoCaoDoanhThuLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(tab9_BaoCaoDoanhThuLayout.createSequentialGroup()
                .addGap(16, 16, 16)
                .addComponent(jLabel13)
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(tab5_QLNV, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    ...
                    .addComponent(tab9_BaoCaoDoanhThu, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                .addComponent(tab1_QLLSP, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(tab1_QLLSP, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                ...
                .addComponent(tab4_TimSP, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(tab5_QLNV, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(tab9_BaoCaoDoanhThu, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void tab1_QLLSPMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tab1_QLLSPMouseClicked
        jp1.setVisible(true);
        ...
        tab1_QLLSP.setBackground(Color.white);
        ...
        tab5_QLNV.setBackground(new Color(204,204,255));
        ...
        tab9_BaoCaoDoanhThu.setBackground(new Color(204, 204, 255));
        
        jPanel2.removeAll();
        jPanel2.add(new QuanLyLoaiSP());
        jPanel2.validate();
    }//GEN-LAST:event_tab1_QLLSPMouseClicked
    ...
    private void tab2_QLSPMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tab2_QLSPMouseClicked
        ...
        tab1_QLLSP.setBackground(new Color(204,204,255));
        tab3_XemSP.setBackground(new Color(204,204,255));
        tab4_TimSP.setBackground(new Color(204,204,255));
        tab5_QLNV.setBackground(new Color(204,204,255));
        tab6_DangXuat.setBackground(new Color(204,204,255));
    ...
    private void tab5_QLNVMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tab5_QLNVMouseClicked
        jp1.setVisible(false);
        jp2.setVisible(false);
        jp3.setVisible(false);
        jp4.setVisible(false);
        ...
        tab5_QLNV.setBackground(Color.white);
        tab1_QLLSP.setBackground(new Color(204,204,255));
        tab2_QLSP.setBackground(new Color(204,204,255));
        tab3_XemSP.setBackground(new Color(204,204,255));
        tab4_TimSP.setBackground(new Color(204,204,255));
        ...
        jPanel2.removeAll();
        jPanel2.add(new QuanLyNhanVien());
        jPanel2.validate();
    }//GEN-LAST:event_tab5_QLNVMouseClicked
    ...
    private void tab9_BaoCaoDoanhThuMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tab9_BaoCaoDoanhThuMouseClicked
        jp1.setVisible(false);
        jp2.setVisible(false);
        jp3.setVisible(false);
        jp4.setVisible(false);
        ...
        tab7_QLPhieuNhap.setBackground(new Color(204, 204, 255));
        tab8_QLPhieuXuat.setBackground(new Color(204, 204, 255));
        tab9_BaoCaoDoanhThu.setBackground(Color.white);

        jPanel2.removeAll();
        jPanel2.add(new BaoCaoDoanhThu());
        jPanel2.validate();
    }//GEN-LAST:event_tab9_BaoCaoDoanhThuMouseClicked
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmTrangChuQuanLy.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmTrangChuQuanLy().setVisible(true);
            }
        });
    }
